...
class LoadArticleData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager) {
        ...
        $articleData->setTitle("<h3>Titre article 1</h3>")
                ->setSubtitle("<h5>sous titre article 1</h5>")
        ...
        $article2Data->setTitle("<h3>Titre article 2</h3>")
                ->setSubtitle("<h4>sous titre article 2</h4>")
                ->setContent($dummyContent)
                ->setAuthor("Albert Nonyme")
        ...
        // Crée une réference pour lier cette fixture avec une Erreur
        $this->addReference('article-test2', $articleData);
    }
